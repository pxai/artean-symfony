...
class WorkOrderController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $workOrders = $this->get("cuatrovientos_artean.bo.workorder")->findAllOrders($this->user->getId());
...
/*                $em = $this->getDoctrine()->getEntityManager();
                $em->merge($workOrder);
                $em->flush();*/
                $this->get("cuatrovientos_artean.bo.workorder")->create($workOrder);
   ...
   public function workOrderDetailAction($id=1)
    {
        ...
        $workOrder = $this->get("cuatrovientos_artean.bo.workorder")->findDetail($id, $idapplicant);
 ...
 /*               $em = $this->getDoctrine()->getEntityManager();
   ...
   public function workOrderDeleteSaveAction(WorkOrder $workOrder)
   {
       ...
       if ($workOrder->getIdapplicant() == $this->user->getId()) {
          /* $em->remove($workOrder);
           $em->flush();*/
           $this->get("cuatrovientos_artean.bo.workorder")->remove($workOrder);
       ...
       public function printAction(Request $request)
   {
       ...
       if ($request->getMethod() == 'GET') {
           ...
           $workOrders = $this->get("cuatrovientos_artean.bo.workorder")->findOrdersInDateRange($dates[0],$dates[1],$this->user->getId());
